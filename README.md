...
## 📚 Academic Publication & Open Data
The empirical routing logs, spatial econometric outputs, and system validation metrics generated by this codebase are openly available for peer review. 

* **Preprint Manuscript:** Available on [ResearchGate](https://github.com/neuhovah/uyo-logistics-web)
* **Empirical Dataset:** Containerized as an OGC-standard GeoPackage on [Zenodo](https://doi.org/10.5281/zenodo.22288639)

**To cite this work:**
> Uso-essien, N. E. (2026). Design and Implementation of an Asynchronous Spatial Decision Support System (SDSS) for Topological Route Optimization and Econometric Logistics Analytics in Uyo, Nigeria [Data set]. Zenodo. https://doi.org/10.5281/zenodo.22288639
---
